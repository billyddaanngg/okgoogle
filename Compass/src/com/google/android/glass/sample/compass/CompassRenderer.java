    ...
    private final OrientationManager.OnChangedListener mCompassListener =
        ...
        public void onOrientationChanged(OrientationManager orientationManager) {
            ...
            if(knownPlace != null){
            	...
            	Log.v("Known Place:", "Our Longitude: " + knownPlace.getLatitude());
            }
            
            Log.v("Our Latitude:", "Our Longitude: " + mOrientationManager.hasLocation());
            //OUR CODES!!!!!!!!!!!!!!!!!!!!!!!!!!!!<<<<<<<<<<<<--------------
            //userLocation = mOrientationManager.getLocation();
            //Log.v("Our Latitude:", "Our Longitude: " + mOrientationManager.getLocation().getAltitude());
            /*
            double latitude1 = userLocation.getLatitude();
            double longitude1 = userLocation.getLongitude();
            Log.v("Our Latitude:", "Our Longitude: " + userLocation.getLatitude());
            Log.v("Our longitude:", "Our Longitude: " + userLocation.getLongitude());

            */
            
            /*
			// get google as place
                double latitude2 = knownPlace.getLatitude();
                double longitude2 = knownPlace.getLongitude();
                Log.v("Google's Latitude: " + knownPlace.getLatitude(), "Google's Longitude: " + knownPlace.getLongitude());
			...
			orientationManager.getHeading();
 
			
				if bearing == getHeading +- 20 then do what you want
				{
        ...
        public void onLocationChanged(OrientationManager orientationManager) {
            ...
            knownPlace = new Place(location.getLatitude(), location.getLongitude(), "");
        }
